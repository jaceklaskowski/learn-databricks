...
# MAGIC %md ## Step 1. Install SynapseML Library
# MAGIC
# MAGIC 1. [Manage libraries with %pip commands](https://docs.databricks.com/libraries/notebooks-python-libraries.html#manage-libraries-with-pip-commands)
# MAGIC 1. https://pypi.org/project/synapseml/
